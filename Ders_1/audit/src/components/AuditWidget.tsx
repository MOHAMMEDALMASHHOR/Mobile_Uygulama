...
interface Props {
  ...
  onNoteSaved?: (notes: AuditNote[], exportMd: () => Promise<void>) => void;
}
...
export function AuditWidget({ deps, appName = 'App', initialPosition, onNoteSaved }: Props) {
  ...
  const handleSaveNote = async (noteText: string) => {
    ...
    if (onNoteSaved) {
      onNoteSaved(all, handleExportMd);
    }
  };
